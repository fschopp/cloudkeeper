...
public abstract class SimpleModule<D extends SimpleModule<D>> extends Module<D> implements BareSimpleModule {
     ...
     *
     * @see xyz.cloudkeeper.model.api.ModuleConnector#getExecutionTrace()
     */
     ...
     * @throws xyz.cloudkeeper.model.api.ConnectorException If the value cannot be retrieved; for instance,
     ...
     * @throws xyz.cloudkeeper.model.api.ConnectorException If the value cannot be written; for instance, because
