...
public final class LinkerOptions {
    ...
    public static class Builder {
         ...
         * <ul>><li>
         *     {@link xyz.cloudkeeper.model.runtime.element.type.RuntimeTypeDeclaration#toClass()}
         * </li><li>
         *     any method of the {@link xyz.cloudkeeper.model.api.Marshaler} returned by
         *     {@link xyz.cloudkeeper.model.runtime.element.serialization.RuntimeSerializationDeclaration#getInstance()}
         * </li></ul>
         *
         ...
         * {@link xyz.cloudkeeper.model.api.Executable} instance, but always an empty {@link Optional}.
         *
         * @param executableProvider executable provider that will be used to resolve qualified names of simple-module
         *     declarations into {@link xyz.cloudkeeper.model.api.Executable} instances
         * @return this builder
         */
        ...
        /**
         * Sets that the value of {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getRaw()}
         * should be computed (by serializing
         * {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getValue()}) if the
         * corresponding property is not available in the bare model given to the linker.
         *
         * <p>If this option is true, method
         * {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getRaw()} is guaranteed to
         ...
         * {@link xyz.cloudkeeper.model.PreprocessingException} will be thrown if serialization fails for any
         * reason.
         *
         ...
         * {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getValue()} should be computed
         * (by deserializing {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getRaw()}) if
         * the corresponding property is not available in the bare model given to the linker.
         *
         * <p>If this option is true, method
         * {@link xyz.cloudkeeper.model.runtime.element.module.RuntimeInputModule#getValue()} is guaranteed to
         * return non-null results.
         *
     ...
     * {@link xyz.cloudkeeper.model.api.Executable} instances are not available.
     */
